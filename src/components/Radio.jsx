...
export default class Radio extends Component{
    ...
    render(){
        let {children,text,value,onSelect,selected,disabled,secText,locale,showTitle} = this.props;
        let cls = getCss({
        ...
        return (
            <div title={showTitle?text:''} className={className} onClick={this.onSelect.bind(this,value)}>
