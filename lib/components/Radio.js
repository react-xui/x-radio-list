    ...
    _createClass(Radio, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                'div',
                { className: className, onClick: this.onSelect.bind(this, value) },
                _react2.default.createElement(
                    'div',
                    { className: 'x-radio-text' },
                    text
                ),
                secText && _react2.default.createElement(
                    'div',
                    { className: 'x-radio-text-sec' },
                    secText
                ),
                _react2.default.createElement(
                    'div',
                    { className: 'x-radio-value' },
                    value
                )
            );
        }
